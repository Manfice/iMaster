...
namespace Web
{
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context) 
        {
            ...
            if (dataProtectionProvider != null)
            {
                manager.UserTokenProvider = 
                    new DataProtectorTokenProvider<ApplicationUser>(dataProtectionProvider.Create("iMaster"));
            }
            return manager;
        }
    }
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole>, IDisposable
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<ApplicationRole>(context.Get<Context>()));
        }
    }
